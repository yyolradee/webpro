        ...
        <section class="container">
            <div class="content">
                <div class="field">
                    ...
                    <input class="input" type="text" name="title" placeholder="Blog title" value="" v-model="title" />
                ...
                <div class="file">
                    <label class="file-label">
                        <input class="file-input" type="file" name="blog_image" @change="handleFileUpload()" />
                        <span class="file-cta">
