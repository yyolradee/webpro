...
#### [](#anyconcatschema)`any.concat(schema)`
...
#### [](#anyruleset---aliases-)`any.ruleset` - aliases: `$`
...
#### [](#arrayuniquecomparator-options)`array.unique([comparator, [options]])`
...
#### [](#-functionminarityn)`function.minArity(n)`
...
#### [](#objectwithkey-peers-options)`object.with(key, peers, [options])`
...
#### [](#stringipoptions)`string.ip([options])`
...
#### [](#stringisoduration)`string.isoDuration()`
...
#### [](#stringlengthlimit-encoding)`string.length(limit, [encoding])`
...
#### [](#stringmaxlimit-encoding)`string.max(limit, [encoding])`
...
#### [](#stringminlimit-encoding)`string.min(limit, [encoding])`
...
#### [](#stringnormalizeform)`string.normalize([form])`

Requires the string value to be in a [Unicode normalized](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/String/normalize) form. If the validation `convert` option is on (enabled by default), the string will be normalized.
...
#### [](#stringpatternregex-name--options---aliases-regex)`string.pattern(regex, [name | options])` - aliases: `regex`
...
#### [](#stringreplacepattern-replacement)`string.replace(pattern, replacement)`

Replace characters matching the given _pattern_ with the specified _replacement_ string where:
...
#### [](#stringtrimenabled)`string.trim([enabled])`
...
#### [](#stringtruncateenabled)`string.truncate([enabled])`
...
#### [](#stringurioptions)`string.uri([options])`
...
#### [](#_parentmethod-args)$\_parent(method, ...args)
...
#### [](#_addruleoptions)$\_addRule(options)
...
#### [](#_compileschema-options)$\_compile(schema, options)
...
#### [](#_createerrorcode-value-local-state-prefs-options)$\_createError(code, value, local, state, prefs, options)
...
#### [](#_getflagname)$\_getFlag(name)

Gets a flag named `name`.

#### [](#_getrulename)$\_getRule(name)

Gets a single (`multi` set to `false`) rule named `name`.

#### [](#_maplabelspath)$\_mapLabels(path)

TODO

#### [](#_matchvalue-state-prefs-overrides)$\_match(value, state, prefs, overrides)

TODO

#### [](#_modifyoptions)$\_modify(options)
...
#### [](#_mutateregisterschema-options)$\_mutateRegister(schema, options)
...
#### [](#_setflagname-value-options)$\_setFlag(name, value, options)
...
#### [](#_validatevalue-state-prefs)$\_validate(value, state, prefs)
...
#### [](#alternativesone)`alternatives.one`

The value matched more than one alternative schema.

#### [](#alternativestypes)`alternatives.types`
...
#### [](#arrayincludesrequiredboth)`array.includesRequiredBoth`
...
#### [](#arrayincludesrequiredknowns)`array.includesRequiredKnowns`
...
#### [](#arrayorderedlength)`array.orderedLength`
...
#### [](#arraysortmismatching)`array.sort.mismatching`

Failed sorting the array due to mismatching item types.

#### [](#arraysortunsupported)`array.sort.unsupported`
...
#### [](#arrayhasunknown)`array.hasUnknown`
...
#### [](#functionmaxarity)`function.maxArity`
...
#### [](#functionminarity)`function.minArity`
...
#### [](#numberinteger-1)`number.integer`
...
#### [](#numbermultiple)`number.multiple`
...
#### [](#numbernegative-1)`number.negative`

The number was positive.

#### [](#numberport-1)`number.port`

The number didn't look like a port number.

#### [](#numberpositive-1)`number.positive`
...
#### [](#objectpatternmatch)`object.pattern.match`
...
#### [](#objectreftype)`object.refType`

The object is not a [`Joi.ref()`](#refkey-options).

#### [](#objectregex-1)`object.regex`

The object is not a `RegExp` object.

#### [](#objectrenamemultiple)`object.rename.multiple`
...
#### [](#objectrenameoverride)`object.rename.override`
...
#### [](#stringalphanum-1)`string.alphanum`

The string doesn't only contain alphanumeric characters.

#### [](#stringbase64)`string.base64`
...
#### [](#stringcreditcard-1)`string.creditCard`

The string is not a valid credit card number.

#### [](#stringdatauri)`string.dataUri`
...
#### [](#stringhexalign)`string.hexAlign`
...
#### [](#stringhostname-1)`string.hostname`

The string is not a valid hostname.

#### [](#stringipversion)`string.ipVersion`
...
#### [](#stringisodate-1)`string.isoDate`

The string is not a valid ISO date string.

#### [](#stringisoduration-1)`string.isoDuration`
...
#### [](#stringlowercase-1)`string.lowercase`
...
#### [](#stringpatterninvertbase)`string.pattern.invert.base`
...
#### [](#stringpatterninvertname)`string.pattern.invert.name`
...
#### [](#stringuppercase-1)`string.uppercase`
...
#### [](#stringuricustomscheme)`string.uriCustomScheme`
...
#### [](#stringurirelativeonly)`string.uriRelativeOnly`
